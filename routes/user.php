...
// Views routes
Route::middleware(['auth:sanctum', 'complete.kyc', 'two-factor'])->get('/dashboard', [ViewsController::class, 'dashboard'])->name('dashboard');

Route::middleware(['auth:sanctum', 'two-factor'])->prefix('dashboard')->group(function () {
